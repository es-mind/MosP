...
%>
	<button type="button" id="btnRegist" class="Name4Button" onclick="submitRegist(event, 'divHistoryCard', null, '<%= HumanHistoryCardAction.CMD_ADD %>')"><%= PfNameUtility.insert(params) %></button>
<%
} else if (vo.getModeCardEdit().equals(PlatformConst.MODE_CARD_EDIT_EDIT)) {
%>
	<button type="button" id="btnRegist" class="Name4Button" onclick="submitRegist(event, 'divHistoryCard', null, '<%= HumanHistoryCardAction.CMD_UPDATE %>')"><%= PfNameUtility.update(params) %></button>
<%
}
%>
