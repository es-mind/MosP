	...
	<table class="ListTable">
		...
		<tbody>
			<tr>
				...
				<td class="TitleTd"><%= HtmlUtility.getRequiredMark() %><label for="txtEditCode"><%= PfNameUtility.importCode(params) %></label></td>
				<td class="InputTd">
			...
			<tr>
				<td class="TitleTd"><%= HtmlUtility.getRequiredMark() %><label for="txtEditName"><%= PfNameUtility.importName(params) %></label></td>
				<td class="InputTd">
...
<div class="Select">
	...
	<div class="Button">
		<button type="button" id="btnRegist" class="Name4Button" onclick="submitRegist(event, 'divEdit', checkExtra, '<%= ImportCardAction.CMD_REGIST %>');"><%= PfNameUtility.insert(params) %></button>
		<button type="button" id="btnDelete" class="Name4Button" onclick="submitDelete(event, null, null, '<%= ImportCardAction.CMD_DELETE %>');"><%= PfNameUtility.delete(params) %></button>
