...
%>
<div class="Button">
	<button type="button" id="btn" class="Name6Button" onclick="submitTransfer(event, null, null, null, '<%=SpecialHolidayManagementAction.CMD_SHOW%>');"><%=params.getName("Specially")%><%=params.getName("Holiday")%><%=params.getName("Confirmation")%></button>
</div>
<div class="List">
