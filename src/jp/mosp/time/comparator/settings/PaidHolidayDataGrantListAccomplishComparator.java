 ...
 * 
 */
public class PaidHolidayDataGrantListAccomplishComparator implements Comparator<PaidHolidayDataGrantListDtoInterface> {
	
	@Override
	public int compare(PaidHolidayDataGrantListDtoInterface dto1, PaidHolidayDataGrantListDtoInterface dto2) {
		return dto1.getAccomplish().compareTo(dto2.getAccomplish());
	}
