 ...
 *
 */
public class HolidayRequestRequestReasonComparator implements Comparator<HolidayRequestListDtoInterface> {
	
	@Override
	public int compare(HolidayRequestListDtoInterface dto1, HolidayRequestListDtoInterface dto2) {
		return dto1.getRequestReason().compareTo(dto2.getRequestReason());
	}
