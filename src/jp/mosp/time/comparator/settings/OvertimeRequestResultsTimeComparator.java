 ...
 *
 */
public class OvertimeRequestResultsTimeComparator implements Comparator<OvertimeRequestListDtoInterface> {
	
	@Override
	public int compare(OvertimeRequestListDtoInterface dto1, OvertimeRequestListDtoInterface dto2) {
		return dto1.getResultsTime().compareTo(dto2.getResultsTime());
	}
