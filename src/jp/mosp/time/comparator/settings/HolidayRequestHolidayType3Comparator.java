 ...
 *
 */
public class HolidayRequestHolidayType3Comparator implements Comparator<HolidayRequestListDtoInterface> {
	
	@Override
	public int compare(HolidayRequestListDtoInterface dto1, HolidayRequestListDtoInterface dto2) {
		return dto2.getHolidayRange() - dto1.getHolidayRange();
	}
