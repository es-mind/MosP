 ...
 *
 */
public class HolidayRequestHolidayType2Comparator implements Comparator<HolidayRequestListDtoInterface> {
	
	@Override
	public int compare(HolidayRequestListDtoInterface dto1, HolidayRequestListDtoInterface dto2) {
		return dto1.getHolidayType2().compareTo(dto2.getHolidayType2());
	}
