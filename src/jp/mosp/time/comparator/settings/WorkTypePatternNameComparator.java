...
/**
 * 勤務形態パターン名称による比較クラス。<br>
 */
public class WorkTypePatternNameComparator implements Comparator<WorkTypePatternDtoInterface> {
	
	@Override
	public int compare(WorkTypePatternDtoInterface dto1, WorkTypePatternDtoInterface dto2) {
		return dto1.getPatternName().compareTo(dto2.getPatternName());
	}
