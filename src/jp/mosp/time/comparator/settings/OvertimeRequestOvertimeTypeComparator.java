 ...
 * 
 */
public class OvertimeRequestOvertimeTypeComparator implements Comparator<OvertimeRequestListDtoInterface> {
	
	@Override
	public int compare(OvertimeRequestListDtoInterface dto1, OvertimeRequestListDtoInterface dto2) {
		return dto2.getOvertimeType() - dto1.getOvertimeType();
	}
