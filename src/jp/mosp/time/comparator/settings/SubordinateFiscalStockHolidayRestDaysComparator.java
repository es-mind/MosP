 ...
 * ストック休暇残日数比較クラス。<br>
 */
public class SubordinateFiscalStockHolidayRestDaysComparator implements Comparator<SubordinateFiscalListDtoInterface> {
	
	@Override
	public int compare(SubordinateFiscalListDtoInterface dto1, SubordinateFiscalListDtoInterface dto2) {
		return Double.compare(dto1.getStockHolidayRestDays(), dto2.getStockHolidayRestDays());
	}
