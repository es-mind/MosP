...
/**
 * 設定適用参照クラスをカレンダコードで比較するクラス。<br>
 */
public class ApplicationReferenceScheduleComparator implements Comparator<ApplicationReferenceDtoInterface> {
	
	@Override
	public int compare(ApplicationReferenceDtoInterface dto1, ApplicationReferenceDtoInterface dto2) {
		return dto1.getScheduleCode().compareTo(dto2.getScheduleCode());
	}
