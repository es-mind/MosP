...
/**
 * 勤務形態パターン略称による比較クラス。<br>
 */
public class WorkTypePatternAbbrComparator implements Comparator<WorkTypePatternDtoInterface> {
	
	@Override
	public int compare(WorkTypePatternDtoInterface dto1, WorkTypePatternDtoInterface dto2) {
		return dto1.getPatternAbbr().compareTo(dto2.getPatternAbbr());
	}
