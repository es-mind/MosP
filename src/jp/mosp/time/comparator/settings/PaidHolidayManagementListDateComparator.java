 ...
 *
 */
public class PaidHolidayManagementListDateComparator implements Comparator<PaidHolidayManagementListDtoInterface> {
	
	@Override
	public int compare(PaidHolidayManagementListDtoInterface dto1, PaidHolidayManagementListDtoInterface dto2) {
		return Double.compare(dto1.getDate(), dto2.getDate());
	}
