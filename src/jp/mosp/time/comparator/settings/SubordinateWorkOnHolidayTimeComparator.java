...
public class SubordinateWorkOnHolidayTimeComparator implements Comparator<SubordinateListDtoInterface> {
	...
	public int compare(SubordinateListDtoInterface dto1, SubordinateListDtoInterface dto2) {
		if (dto1.getWorkOnHolidayTime() == null && dto2.getWorkOnHolidayTime() == null) {
			return 0;
		}
		if (dto1.getWorkOnHolidayTime() == null) {
			return -1;
		}
		if (dto2.getWorkOnHolidayTime() == null) {
			return 1;
		}
		return Double.compare(dto1.getWorkOnHolidayTime(), dto2.getWorkOnHolidayTime());
	}
