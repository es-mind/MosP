 ...
 *
 */
public class ManagementRequestRequestTypeComparator implements Comparator<ManagementRequestListDtoInterface> {
	
	@Override
	public int compare(ManagementRequestListDtoInterface dto1, ManagementRequestListDtoInterface dto2) {
		return dto1.getRequestType().compareTo(dto2.getRequestType());
	}
