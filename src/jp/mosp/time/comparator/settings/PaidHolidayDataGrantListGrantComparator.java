 ...
 * 
 */
public class PaidHolidayDataGrantListGrantComparator implements Comparator<PaidHolidayDataGrantListDtoInterface> {
	
	@Override
	public int compare(PaidHolidayDataGrantListDtoInterface dto1, PaidHolidayDataGrantListDtoInterface dto2) {
		return dto1.getGrant().compareTo(dto2.getGrant());
	}
