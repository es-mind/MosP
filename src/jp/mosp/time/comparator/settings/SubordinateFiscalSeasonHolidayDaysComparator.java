 ...
 * 休暇始比較クラス。<br>
 */
public class SubordinateFiscalSeasonHolidayDaysComparator implements Comparator<SubordinateFiscalListDtoInterface> {
	
	@Override
	public int compare(SubordinateFiscalListDtoInterface dto1, SubordinateFiscalListDtoInterface dto2) {
		return Double.compare(dto1.getSeasonHolidayDays(), dto2.getSeasonHolidayDays());
	}
}
