 ...
 * ストック休暇日数比較クラス。<br>
 */
public class SubordinateFiscalStockHolidayDaysComparator implements Comparator<SubordinateFiscalListDtoInterface> {
	
	@Override
	public int compare(SubordinateFiscalListDtoInterface dto1, SubordinateFiscalListDtoInterface dto2) {
		return Double.compare(dto1.getStockHolidayDays(), dto2.getStockHolidayDays());
	}
