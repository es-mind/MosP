...
/**
 * 勤怠一覧情報備考設定処理(勤務形態変更申請)。<br>
 */
public class AttendListReferRemarkWorkTypeChangeBean extends AttendListReferRemarkBaseBean {
	...
	protected String getRemark(AttendListEntityInterface entity, AttendanceListDto dto) throws MospException {
		...
		// 振出・休出申請情報を取得
		WorkTypeChangeRequestDtoInterface request = requestEntity.getWorkTypeChangeRequestDto(statuses);
		...
		// 接頭辞を準備
		String prefix = TimeNamingUtility.workTypeChangeAbbr(mospParams);
		// 備考を取得
