...
/**
 * 時差出勤申請登録追加処理インターフェース。<br>
 */
public interface DifferenceRequestRegistAddonBeanInterface {
	 ...
	 * @return 初期DTO
	 */
	DifferenceRequestDtoInterface getInitDto(DifferenceRequestDtoInterface dto);
	 ...
	 * @throws MospException エラーが発生した場合
	 */
	void checkInsert(DifferenceRequestDtoInterface dto) throws MospException;
	 ...
	 * @throws MospException エラーが発生した場合
	 */
	void checkAdd(DifferenceRequestDtoInterface dto) throws MospException;
