...
/**
 * 勤怠計算(日々)追加処理インターフェース。<br>
 */
public interface AttendCalcExtraBeanInterface extends BaseBeanInterface {
	...
	/**
	 * 勤怠計算(日々)追加処理を実行する。<br>
	 * <br>
	 * @param attendance 勤怠(日々)エンティティ
	 * @throws MospException インスタンスの取得或いはSQL実行に失敗した場合
	 */
	void execute(AttendanceEntityInterface attendance) throws MospException;
