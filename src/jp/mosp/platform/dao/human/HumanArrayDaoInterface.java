 ...
 * 人事汎用一覧情報DAOインターフェース。
 */
public interface HumanArrayDaoInterface extends BaseDaoInterface {
	 ...
	 * @throws MospException SQLの作成に失敗した場合、或いはSQL例外が発生した場合
	 */
	List<HumanArrayDtoInterface> findForInfoNotIn(List<String> itemNames) throws MospException;
