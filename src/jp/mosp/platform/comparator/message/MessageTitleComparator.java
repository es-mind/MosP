...
/**
 * メッセージタイトルによる比較クラス。<br>
 */
public class MessageTitleComparator implements Comparator<MessageDtoInterface> {
	
	@Override
	public int compare(MessageDtoInterface dto1, MessageDtoInterface dto2) {
		return dto1.getMessageTitle().compareTo(dto2.getMessageTitle());
	}
