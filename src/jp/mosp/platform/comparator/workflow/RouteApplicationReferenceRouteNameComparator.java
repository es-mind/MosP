...
/**
 * ルート適用参照クラスをルート名称で比較するクラス。
 */
public class RouteApplicationReferenceRouteNameComparator implements Comparator<RouteApplicationReferenceDtoInterface> {
	
	@Override
	public int compare(RouteApplicationReferenceDtoInterface dto1, RouteApplicationReferenceDtoInterface dto2) {
		return dto1.getRouteName().compareTo(dto2.getRouteName());
	}
