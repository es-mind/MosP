...
/**
 * 人事汎用バイナリ通常情報DTOインターフェース。
 */
public interface HumanBinaryNormalDtoInterface extends PlatformDtoInterface {
	
	/**
	 * @return レコード識別ID。
	 */
	long getPfaHumanBinaryNormalId();
	...
	/**
	 * @param pfaHumanBinaryNormalId セットする レコード識別ID。
	 */
	void setPfaHumanBinaryNormalId(long pfaHumanBinaryNormalId);
